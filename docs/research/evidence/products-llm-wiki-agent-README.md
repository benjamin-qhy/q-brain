...
- [awesome-jev-by-typesafe](https://github.com/Anil-matcha/awesome-jev-by-typesafe) — typed semantic retrieval, citation checks, and confidence-aware routing for agent knowledge workflows
